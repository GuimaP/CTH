...
public class LogController {
	public static void insertLog(Exception e){
         ...
         String dirPath = Start.class.getClass().getResource("/").getPath() + nameFile; //Monto o caminho que ser� salvo esse arquivo
         
         
         File arquivoLog = new File(dirPath); //Instancio um arquivo
         if (!arquivoLog.exists()) { //Verifico se o arquivo existe
        	 arquivoLog.createNewFile();//Se n�o eu crio um novo
         }
