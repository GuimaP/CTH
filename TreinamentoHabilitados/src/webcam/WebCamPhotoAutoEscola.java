        ...
        if (webcam == null) {
            ...
            this.addMouseMotionListener(new MouseMotionAdapter() {
                public void mouseDragged(MouseEvent e) {
                    Point p = minhaDialog.getLocation();//pego a localiza��o da frame no ato de arrastar
                    minhaDialog.setLocation(p.x + e.getX() - point.x, p.y + e.getY() - point.y); // e ent�o eu subtraio a localiza��o dela, mais a onde eu cliquei 
                }
            });
        }
