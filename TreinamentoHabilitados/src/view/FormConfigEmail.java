...
public class FormConfigEmail extends JInternalFrame {
	...
	public FormConfigEmail(Login u){
		this.loginUser = u;
		initComponents();
		defineEvents();
	...
	private void defineEvents(){
			...
			//
				...
				new Thread(()->{
					...
					try {
						...
						FormConfigEmail.btRefreshItens.setVisible(false);
					}
		...
		this.addInternalFrameListener(new InternalFrameAdapter() {
			...
			public void internalFrameClosing(InternalFrameEvent e) {
				...
				Principal.isFrameConfigEmail = false;
				setVisible(false);
			}
		});
		}
