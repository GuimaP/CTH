            ...
            public void mouseClicked(MouseEvent e) {
                ...
                try {
                    if (e.getClickCount() == 2) {
                        ...
                        //Antes de abrir a camera, eu salvo todas as informa√ß√µes para restaura depois
                        populaObjInstrutor();
...
//                        JOptionPane.showMessageDialog(rootPane, strPath);
                        ...
                        String strNameFile = tfNome.getText(); //Pego o nome que ser√° a imagem
                        ...
                        //Verifica se existe uma foto, pois pode muito bem o fulano n√£o ter tirado uma foto.
                        if (!path.isEmpty() & fotoTirada.exists()) {
                            ...
                            minhaInternal.revalidate(); //revalido as altera√ß√µes
        ...
        btSalvar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (tfNome.getText().isEmpty()) { // ValidaÁıes, verifico se est„o vazio
