 ...
 */
public class WebCamPhotoAutoEscola extends JDialog implements Runnable,
	...
	public WebCamPhotoAutoEscola(JFrame minhaFrame, String strPath,
			String strNameFile) {
		super(minhaFrame);
		minhaDialog = this;
		...
		System.out.println("Construtor First");
	...
	public void run() {
		...
		if (webcam == null) {
			JOptionPane.showMessageDialog(this,
					"Não foi encontrado uma Web cam conectada");
			sucess = false;
			return;
			...
			btSair.addActionListener(e -> minhaDialog.dispose());
			...
			this.addMouseListener(new MouseAdapter() {
				public void mousePressed(MouseEvent e) {
					point.x = e.getX();// Pego a posição a localização da frame
										// quando clicado
					point.y = e.getY();
				}
			});
			...
			this.addMouseMotionListener(new MouseMotionAdapter() {
				public void mouseDragged(MouseEvent e) {
					Point p = minhaDialog.getLocation();// pego a localização da
														// frame no ato de
														// arrastar
					minhaDialog.setLocation(p.x + e.getX() - point.x,
							p.y + e.getY() - point.y); // e então eu subtraio a
														// localização dela,
														// mais a onde eu
														// cliquei
				}
