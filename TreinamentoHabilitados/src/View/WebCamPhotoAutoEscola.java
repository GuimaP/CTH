...
public class WebCamPhotoAutoEscola extends JDialog implements Runnable, WebcamListener, WindowListener, UncaughtExceptionHandler, ItemListener,Serializable {
    ...
    public void run() {
        ...
        if (webcam == null) {
            JOptionPane.showMessageDialog(this, "Não foi encontrado uma Web cam conectada");
            sucess = false;
            ...
            this.addMouseMotionListener(new MouseMotionAdapter() {
                public void mouseDragged(MouseEvent e) {
                    Point p = minhaDialog.getLocation();//pego a localização da frame no ato de arrastar
                    minhaDialog.setLocation(p.x + e.getX() - point.x, p.y + e.getY() - point.y); // e então eu subtraio a localização dela, mais a onde eu cliquei 
                }
            });
        }
